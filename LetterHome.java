...
//nidho
//lab5
//1)sentenceCode should be > MAX_CODE, not >=
//2)in the weatherModifier, there is a semicolon next to the m==2 that should be removed
//3)the semicolon next to "else" for sentenceCode==5 causes an error and should be removed
//--------------------------------------------------------------
...
class LetterHome{
   ...
   public static void main(String[] args) throws Exception{
      ...
      while( in.hasNext() ){
         ...
         if( (sentenceCode < 1) || (sentenceCode > MAX_CODE) ) { //error fixed
